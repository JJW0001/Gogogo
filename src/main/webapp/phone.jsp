...
<head>
    ...
    <title>手机-综合网购首选-正品低价、品质保障、配送及时、轻松购物！
    </title>
    <!-- 网站说明 -->
    ...
    <div class="w">
        ...
        <div class="sk_con">
            <ul>
                ...
                <li><a href="GetAllPhoneServlet" class="style_red">手机</a></li>
...
<div class="w sk_container">
    <div class="sk_bd">
        <ul class="clearfix">
        	<c:set var="thisPage" value="phone.jsp" scope="page"/><!-- 标记此页面，当加入购物车之后自动跳回 -->
        	<!-- 循环显示手机列表 -->
        	<c:forEach var="map" items="${requestScope.allPhone}">
			    <li>
