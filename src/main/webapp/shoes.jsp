...
<head>
    ...
    <title>男鞋-综合网购首选-正品低价、品质保障、配送及时、轻松购物！
    </title>
    <!-- 网站说明 -->
    ...
    <div class="w">
        ...
        <div class="sk_con">
            <ul>
                ...
                <li><a href="GetAllShoesServlet" class="style_red">男鞋</a></li>
                <li><a href="#">珠宝</a></li>
                <li><a href="#">电脑</a></li>
                <li><a href="#">运动</a></li>
                <li><a href="#">休闲</a></li>
...
<div class="w sk_container">
    <div class="sk_bd">
        <ul class="clearfix">
        	<c:set var="thisPage" value="shoes.jsp" scope="page"/><!-- 标记此页面，当加入购物车之后自动跳回 -->
        	<!-- 循环显示鞋子列表 -->
        	<c:forEach var="map" items="${requestScope.allShoes}">
			    <li>
                <img src="${map.shelves_adr}" alt="">
                <em>￥</em>
                <i>${map.goods_price}0</i>
                <div class="p-name">
                    <a href=""><strong>【官方推荐 加绒可选】</strong>
                        高帮鞋男冬季保暖<span class="style_red">新款</span>${map.goods_desc}  
                    </a>
                </div>
                <a href="AddCart?userName=${sessionScope.userName}&goodsNo=${map.goods_no}&thisPage=${pageScope.thisPage}" class="bg">加入购物车</a>
            </li>    	
        	</c:forEach>
        </ul>
    </div>
